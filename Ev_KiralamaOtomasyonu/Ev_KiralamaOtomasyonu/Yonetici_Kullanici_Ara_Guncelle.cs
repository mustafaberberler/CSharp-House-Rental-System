...
namespace Ev_KiralamaOtomasyonu
{
    public partial class Yonetici_Kullanici_Ara_Guncelle : Form
    {
        ...
        private void Kullanici_Ara_Guncelle_Load(object sender, EventArgs e)
        {
            ...
            picBoxKullaniciFoto2.Width = 150;
            picBoxKullaniciFoto2.Height = 150;
        ...
        private void button3_Click(object sender, EventArgs e)     // arama butonu
        {
            ...
            if (txtTcNo.Text.Length == 11)
            {
                ...
                while (kayitoku.Read())
                {
                    ...
                    dateTimePickerDogumTarihi.Text = kayitoku.GetValue(8).ToString();  
        ...
        {
            if (char.IsLetter(e.KeyChar) == true || char.IsDigit(e.KeyChar) == true || char.IsControl(e.KeyChar) == true)     
            {
                e.Handled = false;
            }
            else
        ...
        private void button5_Click(object sender, EventArgs e)    // kayıt güncelleme butonu
        {
            ...
            string cinsiyet = "";
                ...
                {
                    baglanti.Open();
                    SqlCommand guncellekomut2 = new SqlCommand("update Tbl_kiralananEvler set tcno='" + txtTcNo.Text + "', kiralayan_ad='" + txtAdiniz.Text + "', kiralayan_soyad='" + txtSoyadiniz.Text + "' where tcno='" + Uye_Giris_Ekrani.tcno + "'", baglanti);   // Eğer mevcut kişi halihazırda bir kiracıysa, Tbl_kiralananEvler tablosundan yani kiracılar listesinde de bu kişinin bilgilerinin güncellenmesi sağlandı
                    guncellekomut2.ExecuteNonQuery(); // Yazılan komutun gerçekleştirilmesi sağlandı
                    baglanti.Close();
                }
                catch (Exception errormsg)
                {
